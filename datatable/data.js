/**
 * Provides YAHOO.example.Data.
 *  apitester (13): [ { number:n, date:d, string:s },...]
 *  multitypes : {
 *      items (10): [{field1:x, field2:x, field3 4 5 6},...] }
 *  webstats (5): [ ["home.html",20,400,44,657],...]
 *  emails : {
 *      account:"jenny@yahoo.com", currStorage: 10, maxStorage: 200,
 *      messages (5): [
 *          { XID:s, Date:d, To:s, From:s, Unread:b, Subject:s },...]}
 *  inventory (14): [ {SKU:s, Quantity:n, Item:s, Description:s },... ]
 *  addresses (18): [ {name:s, address:s, city:s, state:s, amount:n, active:s,
 *                 colors: [s], last_login:s },...]
 *  bookorders (4): [ {id:s, date:d, quantity:n, amount:n, title:s},... ]
 *  stateAbbrs : [ "AL","AK",... ]
 *  areacodes (327): [ { areacode:s, state:s },...]
 */
